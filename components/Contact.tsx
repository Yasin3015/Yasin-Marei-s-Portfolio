        ...
        <div className="mt-5">
          ...
          <div className="flex items-center mt-8 text-gray-600 dark:text-gray-400">
            ...
            <div className="ml-4 text-md tracking-wide font-semibold w-40">
              <Link
                href={
                  "https://wa.me/+201090257503?text=السلام عليكم و رحمة الله و بركاته باشمهندس ياسين انا :"
                }
            ...
            <div className="flex gap-5 items-center justify-center flex-col sm:flex-row">
              <div className="flex-1 w-full">
                ...
                <input
                  id="email"
                  type="email"
                  placeholder="Ex. yas@example.com"
                  // {...register("email")}
                  className="mt-1 block w-full px-4 py-3 rounded-[10px] bg-black-100 shadow-sm focus:outline-none sm:text-sm"
                />
                {/* {errors && errors?.email && (
